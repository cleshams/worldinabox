                            ...
                            <div class="dropdown">
                                <ul>
                                    ...
                                    foreach($units as $unit)
                                    {
                                        $title = $unit->name;
                                        $slug = $unit->slug;
                                        $validClass = (in_array($slug, array_keys($_SESSION['memberships'])) || in_array('world-in-a-box-full', array_keys($_SESSION['memberships'])) || in_array('world-in-a-box-full-copy', array_keys($_SESSION['memberships']))) ? '' : ' class="invalid"';
